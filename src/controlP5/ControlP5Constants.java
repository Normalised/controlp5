...
public interface ControlP5Constants {
    ...
    @Deprecated
    static public final int ACTION_PRESSED = 1; // MouseEvent.PRESS
    static public final int ACTION_PRESS = 1; // MouseEvent.PRESS

    @Deprecated
    static public final int ACTION_RELEASED = 2; // MouseEvent.RELEASE
    ...
    @Deprecated
    static public final int ACTION_RELEASEDOUTSIDE = 9;
