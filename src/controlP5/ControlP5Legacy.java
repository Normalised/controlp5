...
public class ControlP5Legacy {
     ...
     */
    @ControlP5.Invisible
    public <C> C addGroup(final Object theObject, final String theIndex, final String theName, final Class<C> theClass, float theX, float theY, int theW, int theH) {
        ControlGroup<?> c = null;
    ...
    @Deprecated
    public ControlWindow addControlWindow(final String theName, final float theX, final float theY, final int theWidth, final int theHeight, String theRenderer, int theFrameRate) {
    ...
    @Deprecated
    public ControlWindow addControlWindow(final String theWindowName, final float theX, final float theY, final int theWidth, final int theHeight) {
        return addControlWindow(theWindowName, theX, theY, theWidth, theHeight, "", 30);
    }

    @Deprecated
    public ControlWindow addControlWindow(final String theWindowName, final float theX, final float theY, final int theWidth, final int theHeight, final int theFrameRate) {
        return addControlWindow(theWindowName, theX, theY, theWidth, theHeight, "", theFrameRate);
    }

    @Deprecated
    public Slider2D addSlider2D(String theName, float theX, float theY, int theW, int theH) {
        return addSlider2D(null, "", theName, 0, theW, 0, theH, 0, 0, theX, theY, theW, theH);
    }

    @Deprecated
    public Slider2D addSlider2D(Object theObject, final String theIndex, final String theName, float theX, float theY, int theW, int theH) {
        return addSlider2D(theObject, theIndex, theName, 0, theW, 0, theH, 0, 0, theX, theY, theW, theH);
    }

    @Deprecated
    public Slider2D addSlider2D(String theName, float theMinX, float theMaxX, float theMinY, float theMaxY, float theDefaultValueX, float theDefaultValueY, float theX, float theY, int theW, int theH) {
        return addSlider2D(null, "", theName, theMinX, theMaxX, theMinY, theMaxY, theDefaultValueX, theDefaultValueY, theX, theY, theW, theH);
    }

    @Deprecated
    public Button addButton(final String theName, final float theValue, final float theX, final float theY, final int theW, final int theH) {
        return addButton(null, "", theName, theValue, theX, theY, theW, theH);
    }

    @Deprecated
    public Bang addBang(final String theName, final float theX, final float theY) {
        return addBang(null, "", theName, theX, theY, 20, 20);
    }

    @Deprecated
    public Bang addBang(final String theName, final float theX, final float theY, final int theWidth, final int theHeight) {
