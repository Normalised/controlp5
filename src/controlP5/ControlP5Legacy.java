...
public class ControlP5Legacy {
	...
	public Spacer addSpacer( final String theName , final float theX , final float theY , final int theW , final int theH ) {
	...
	public Background addBackground( Object theObject , final String theIndex , String theName , float theX , float theY , int theW , int theHeight ) {
	...
	public Button addButton( final Object theObject , String theIndex , final String theName , final float theValue , final float theX , final float theY , final int theW , final int theH ) {
	...
	public Icon addIcon( final Object theObject , String theIndex , final String theName , final float theValue , final float theX , final float theY , final int theW , final int theH ) {
	...
	public ButtonBar addButtonBar( final Object theObject , String theIndex , final String theName , final float theValue , final float theX , final float theY , final int theW , final int theH ) {
	...
	public Bang addBang( final Object theObject , String theIndex , final String theName , final float theX , final float theY , final int theWidth , final int theHeight ) {
	...
	public Matrix addMatrix( final Object theObject , final String theIndex , final String theName , final int theCellX , final int theCellY , final float theX , final float theY , final int theWidth , final int theHeight ) {
	...
	public Matrix addMatrix( final String theName , final int theCellX , final int theCellY , final float theX , final float theY , final int theWidth , final int theHeight ) {
		return addMatrix( null , "" , theName , theCellX , theCellY , theX , theY , theWidth , theHeight );
	}

	public Slider2D addSlider2D( Object theObject , final String theIndex , final String theName , float theMinX , float theMaxX , float theMinY , float theMaxY , float theDefaultValueX , float theDefaultValueY , float theX , float theY , int theW , int theH ) {
	...
	public Slider addSlider( Object theObject , final String theIndex , final String theName , float theMin , float theMax , float theDefaultValue , float theX , float theY , int theW , int theH ) {
	...
	public Slider addSlider( String theName , float theMin , float theMax , float theDefaultValue , float theX , float theY , int theW , int theH ) {
		return addSlider( null , "" , theName , theMin , theMax , theDefaultValue , theX , theY , theW , theH );
	}

	public Slider addSlider( final String theName , final float theMin , final float theMax , final float theX , final float theY , final int theWidth , final int theHeight ) {
		return addSlider( null , "" , theName , theMin , theMax , theMin , theX , theY , theWidth , theHeight );
	}

	public Slider addSlider( Object theObject , final String theIndex , final String theName , float theMin , float theMax , float theX , float theY , int theW , int theH ) {
		return addSlider( theObject , theIndex , theName , theMin , theMax , theMin , theX , theY , theW , theH );
	}

	public Range addRange( Object theObject , final String theIndex , String theName , float theMin , float theMax , float theDefaultMinValue , float theDefaultMaxValue , float theX , float theY , int theW , int theH ) {
	...
	public Range addRange( String theName , float theMin , float theMax , float theDefaultMinValue , float theDefaultMaxValue , float theX , float theY , int theW , int theH ) {
		return addRange( null , "" , theName , theMin , theMax , theDefaultMinValue , theDefaultMaxValue , theX , theY , theW , theH );
	}

	public Range addRange( final String theName , final float theMin , final float theMax , final float theX , final float theY , final int theWidth , final int theHeight ) {
		return addRange( null , "" , theName , theMin , theMax , theMin , theMax , theX , theY , theWidth , theHeight );
	}

	public Range addRange( final Object theObject , final String theIndex , final String theName , final float theMin , final float theMax , final float theX , final float theY , final int theWidth , final int theHeight ) {
		return addRange( theObject , theIndex , theName , theMin , theMax , theMin , theMax , theX , theY , theWidth , theHeight );
	}

	public Numberbox addNumberbox( final Object theObject , final String theIndex , final String theName , final float theDefaultValue , final float theX , final float theY , final int theWidth , final int theHeight ) {
	...
	public Numberbox addNumberbox( final String theName , final float theX , final float theY , final int theWidth , final int theHeight ) {
		return addNumberbox( null , "" , theName , Float.NaN , theX , theY , theWidth , theHeight );
	}

	public Numberbox addNumberbox( final Object theObject , final String theIndex , final String theName , final float theX , final float theY , final int theWidth , final int theHeight ) {
		return addNumberbox( theObject , theIndex , theName , Float.NaN , theX , theY , theWidth , theHeight );
	}

	public Numberbox addNumberbox( final String theName , final float theDefaultValue , final float theX , final float theY , final int theWidth , final int theHeight ) {
		return addNumberbox( null , "" , theName , theDefaultValue , theX , theY , theWidth , theHeight );
	}

	public Knob addKnob( final Object theObject , final String theIndex , final String theName , final float theMin , final float theMax , final float theDefaultValue , final float theX , final float theY , final int theDiameter ) {
	...
	public Knob addKnob( final String theName , final float theMin , final float theMax , final float theX , final float theY , final int theDiameter ) {
		return addKnob( null , "" , theName , theMin , theMax , theMin , theX , theY , theDiameter );
	}

	public Knob addKnob( final Object theObject , final String theIndex , final String theName , final float theMin , final float theMax , final float theX , final float theY , final int theDiameter ) {
		return addKnob( theObject , theIndex , theName , theMin , theMax , theX , theY , theDiameter );
	}

	public Knob addKnob( final String theName , final float theMin , final float theMax , final float theDefaultValue , final float theX , final float theY , final int theDiameter ) {
		return addKnob( null , "" , theName , theMin , theMax , theDefaultValue , theX , theY , theDiameter );
	}

	public MultiList addMultiList( final Object theObject , final String theIndex , final String theName , final float theX , final float theY , final int theWidth , final int theHeight ) {
	...
	public MultiList addMultiList( final String theName , final float theX , final float theY , final int theWidth , final int theHeight ) {
	...
	public Textlabel addLabel( String theIndex , float theX , float theY ) {
		return addTextlabel( theIndex , theIndex , theX , theY );
	}

	public Textlabel addTextlabel( final Object theObject , final String theIndex , final String theName , final String theText , final float theX , final float theY ) {
	...
	public Textlabel addTextlabel( final String theName , final String theText , final float theX , final float theY ) {
	...
	public Textarea addTextarea( final String theName , final String theText , final float theX , final float theY , final int theW , final int theH ) {
	...
	public Textfield addTextfield( final Object theObject , final String theIndex , final String theName , final float theX , final float theY , final int theW , final int theH ) {
	...
	public Textfield addTextfield( final String theName , final float theX , final float theY , final int theW , final int theH ) {
	...
	public Accordion addAccordion( String theName , float theX , float theY , int theWidth ) {
	...
	public RadioButton addRadioButton( final Object theObject , String theIndex , final String theName , final float theX , final float theY ) {
	...
	public RadioButton addRadioButton( final String theName , final float theX , final float theY ) {
	...
	public RadioButton addRadio( final String theName , final float theX , final float theY ) {
		RadioButton myController = new RadioButton( base.cp5 , ( Tab ) base.cp5.controlWindow.getTabs( ).get( 1 ) , theName , theX , theY );
		base.cp5.register( null , "" , myController );
		myController.registerProperty( "arrayValue" );
		return myController;
	...
	public CheckBox addCheckBox( final Object theObject , final String theIndex , final String theName , final float theX , final float theY ) {
	...
	public CheckBox addCheckBox( final String theName , final float theX , final float theY ) {
	...
	public ScrollableList addScrollableList( final Object theObject , String theIndex , final String theName , final float theX , final float theY , final int theW , final int theH ) {
	...
	public ScrollableList addScrollableList( final String theName , final float theX , final float theY , final int theW , final int theH ) {
	...
	public ListBox addListBox( final Object theObject , String theIndex , final String theName , final float theX , final float theY , final int theW , final int theH ) {
	...
	public ListBox addListBox( final String theName , final float theX , final float theY , final int theW , final int theH ) {
	...
	public DropdownList addDropdownList( final Object theObject , final String theIndex , final String theName , final float theX , final float theY , final int theW , final int theH ) {
	...
	public DropdownList addDropdownList( final String theName , final float theX , final float theY , final int theW , final int theH ) {
		return addDropdownList( null , "" , theName , theX , theY , theW , theH );
	}

	public ColorWheel addColorWheel( final Object theObject , final String theIndex , final String theName , final float theX , final float theY , final int theW ) {
	...
	public ColorWheel addColorWheel( final String theName , final float theX , final float theY , final int theW ) {
		return addColorWheel( null , "" , theName , theX , theY , theW );
	}

	public ColorPicker addColorPicker( final String theName , final float theX , final float theY , final int theW , final int theH ) {
		return addColorPicker( null , "" , theName , theX , theY , theW , theH );
	}

	public ColorPicker addColorPicker( final Object theObject , final String theIndex , final String theName , final float theX , final float theY , final int theW , final int theH ) {
	...
	public Chart addChart( String theName , float theX , float theY , int theW , int theH ) {
		Chart myController = new Chart( base.cp5 , ( Tab ) base.cp5.controlWindow.getTabs( ).get( 1 ) , theName , theX , theY , theW , theH );
		base.cp5.register( null , "" , myController );
		return myController;
	}

	public Group addGroup( Object theObject , final String theIndex , String theName , float theX , float theY , int theW ) {
		Group myController = new Group( base.cp5 , ( ControllerGroup< ? > ) base.cp5.controlWindow.getTabs( ).get( 1 ) , theName , theX , theY , theW , 9 );
		base.cp5.register( theObject , theIndex , myController );
		return myController;
	}

	public Group addGroup( Object theObject , String theIndex , String theName , float theX , float theY ) {
		return addGroup( theObject , theIndex , theName , theX , theY , 99 );
	}

	public Group addGroup( String theName , float theX , float theY , int theW ) {
	...
	public Group addGroup( String theName , float theX , float theY ) {
		return addGroup( null , "" , theName , theX , theY , 99 );
	}

	public Textlabel getTextlabel( String theText , float theX , float theY ) {
	...
	public Slider addSlider( Object theObject , final String theIndex , String theName , float theMin , float theMax ) {
		Point2D autoPosition = base.currentGroupPointer.autoPosition;
		Slider s = addSlider( theObject , theIndex , theName , theMin , theMax , theMin , autoPosition.x , autoPosition.y , Slider.autoWidth , Slider.autoHeight );
	...
	public Button addButton( Object theObject , final String theIndex , String theName , float theValue ) {
		Point2D autoPosition = base.currentGroupPointer.autoPosition;
		Button b = addButton( theObject , theIndex , theName , theValue , autoPosition.x , autoPosition.y , Button.autoWidth , Button.autoHeight );
	...
	public ButtonBar addButtonBar( Object theObject , final String theIndex , String theName , float theValue ) {
		Point2D autoPosition = base.currentGroupPointer.autoPosition;
		ButtonBar b = addButtonBar( theObject , theIndex , theName , theValue , autoPosition.x , autoPosition.y , Button.autoWidth , Button.autoHeight );
		base.linebreak( b , false , Button.autoWidth , Button.autoHeight , Button.autoSpacing );
		b.moveTo( base.currentGroupPointer );
		return b;
	}
	...
	public Icon addIcon( Object theObject , final String theIndex , String theName , float theValue ) {
		Icon icon = addIcon( theObject , theIndex , theName , theValue , base.currentGroupPointer.autoPosition.x , base.currentGroupPointer.autoPosition.y , Icon.autoWidth , Icon.autoHeight );
	...
	public Bang addBang( Object theObject , final String theIndex , String theName ) {
		Bang b = addBang( theObject , theIndex , theName , base.currentGroupPointer.autoPosition.x , base.currentGroupPointer.autoPosition.y , Bang.autoWidth , Bang.autoHeight );
	...
	public Toggle addToggle( Object theObject , final String theIndex , String theName , boolean theValue ) {
		Toggle t = addToggle( theObject , theIndex , theName , theValue , base.currentGroupPointer.autoPosition.x , base.currentGroupPointer.autoPosition.y , Toggle.autoWidth , Toggle.autoHeight );
	...
	public Numberbox addNumberbox( Object theObject , final String theIndex , String theName ) {
		Numberbox n = addNumberbox( theObject , theIndex , theName , base.currentGroupPointer.autoPosition.x , base.currentGroupPointer.autoPosition.y , Numberbox.autoWidth , Numberbox.autoHeight );
	...
	public Knob addKnob( Object theObject , final String theIndex , String theName , int theMin , int theMax ) {
		Knob n = addKnob( theObject , theIndex , theName , theMin , theMax , theMin , base.currentGroupPointer.autoPosition.x , base.currentGroupPointer.autoPosition.y, Knob.autoWidth );
	 ...
	 */
	public < C > C addController( final Object theObject , final String theIndex , final String theName , final Class< C > theClass , float theX , float theY ) {
		Controller< ? > c = null;
	 ...
	 * @exclude
	 */
	@ControlP5.Invisible public < C > C addGroup( final Object theObject , final String theIndex , final String theName , final Class< C > theClass , float theX , float theY , int theW , int theH ) {
		ControlGroup< ? > c = null;
	...
	public < C > C addController( String theName , Class< C > theClass , float theX , float theY ) {
	...
	@Deprecated public ControlWindow addControlWindow( final String theName , final float theX , final float theY , final int theWidth , final int theHeight , String theRenderer , int theFrameRate ) {
	...
	@Deprecated public ControlWindow addControlWindow( final String theWindowName , final float theX , final float theY , final int theWidth , final int theHeight ) {
		return addControlWindow( theWindowName , theX , theY , theWidth , theHeight , "" , 30 );
	}

	@Deprecated public ControlWindow addControlWindow( final String theWindowName , final float theX , final float theY , final int theWidth , final int theHeight , final int theFrameRate ) {
		return addControlWindow( theWindowName , theX , theY , theWidth , theHeight , "" , theFrameRate );
	}

	@Deprecated public Slider2D addSlider2D( String theName , float theX , float theY , int theW , int theH ) {
		return addSlider2D( null , "" , theName , 0 , theW , 0 , theH , 0 , 0 , theX , theY , theW , theH );
	}

	@Deprecated public Slider2D addSlider2D( Object theObject , final String theIndex , final String theName , float theX , float theY , int theW , int theH ) {
		return addSlider2D( theObject , theIndex , theName , 0 , theW , 0 , theH , 0 , 0 , theX , theY , theW , theH );
	}

	@Deprecated public Slider2D addSlider2D( String theName , float theMinX , float theMaxX , float theMinY , float theMaxY , float theDefaultValueX , float theDefaultValueY , float theX , float theY , int theW , int theH ) {
		return addSlider2D( null , "" , theName , theMinX , theMaxX , theMinY , theMaxY , theDefaultValueX , theDefaultValueY , theX , theY , theW , theH );
	}

	@Deprecated public Button addButton( final String theName , final float theValue , final float theX , final float theY , final int theW , final int theH ) {
		return addButton( null , "" , theName , theValue , theX , theY , theW , theH );
	}

	@Deprecated public Bang addBang( final String theName , final float theX , final float theY ) {
		return addBang( null , "" , theName , theX , theY , 20 , 20 );
	}

	@Deprecated public Bang addBang( final String theName , final float theX , final float theY , final int theWidth , final int theHeight ) {
