...
public class Range extends Controller<Range> {
     ...
     */
    @ControlP5.Invisible
    public Range(ControlP5 theControlP5, ControllerGroup<?> theParent, String theName, float theMin, float theMax, float theDefaultMinValue, float theDefaultMaxValue, float theX, float theY, int theWidth, int theHeight) {
