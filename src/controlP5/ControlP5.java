...
public class ControlP5 extends ControlP5Base {
     ...
     */
    @ControlP5.Invisible
    public static final String VERSION = "2.2.7";// "##version##";
    ...
    public ControllerGroup<?> begin(ControllerGroup<?> theGroup, int theX, int theY) {
        setCurrentPointer(theGroup);
        theGroup.autoPosition.setLocation(theX, theY);
    ...
    public void addPositionTo(Point2D position, List<ControllerInterface<?>> theControllers) {
        for (ControllerInterface<?> c : theControllers) {
            c.setPosition(position.add(c.getPosition()));
        }
    }

    public void addPositionTo(Point2D position, ControllerInterface<?>... theControllers) {
        addPositionTo(position, Arrays.asList(theControllers));
    }
